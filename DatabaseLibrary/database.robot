...
Exemplo 01: Executando scripts SQL via Arquivos
    ...
    Confere se "Francisco Silva" foi inserido com sucesso

Exemplo 02: Executando scripts SQL via STRING
    Executar script via STRING no Banco de Dados        INSERT INTO public.account(user_id, username, password, email) VALUES (2, 'Joao Silva', 'robot987', 'joaosilva@unisal.br')
    Confere se "Joao Silva" foi inserido com sucesso
